...
def reg():
    ...
    if clientp != False or None:
        return render_template('regsuccess.html', name=clientp.name_of_user, email=clientp.e_mail, passwd=clientp._password, phone=clientp.phone, accno=clientp._accountNumber, addr=clientp.address)
    else:
        return 'Reg failed!'
